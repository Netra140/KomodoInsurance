...
namespace KomodoInsurance
{
    class Team
    {
        static Developer[] DevCache = new Developer[0];
        public Developer[] staff { get; set; } //= new Developer[5];
        public string name { get; set; }
        public int id { get; set; }
        public Team (Developer[] people, string nombre, int ident)
        {
            staff = people;
            name = nombre;
            id = ident;
        ...
        public Developer[] GetDevCache()
        {
            return(DevCache);
        }
        public void SetDevCache (Developer[] bob)
        {
            DevCache = bob;
        }
    }
